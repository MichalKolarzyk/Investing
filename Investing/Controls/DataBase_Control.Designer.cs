namespace Investing.Controls
{
    partial class DataBase_Control
    {
        ...
        {
            this.basicButton_CleanDatabase = new Investing.BasicControls.BasicButton();
            this.basicButton_CreateDatabase = new Investing.BasicControls.BasicButton();
            this.basicButton_DeleteDatabase = new Investing.BasicControls.BasicButton();
            this.SuspendLayout();
            // 
